...
class ElevenLabsAdapter(VoiceBackend):
    def __init__(self, api_key: str | None = None, voice_id: str | None = None, cache_dir: str = "cache/voice") -> None:
    ...
    def synthesize(self, text: str, voice_style: VoiceStyle, reference_audio: str | None = None) -> SynthesizedSpeech:
        ...
        if not path.exists():
            ...
            payload = {"text": text, "model_id": "eleven_multilingual_v2", "voice_settings": {"stability": 0.5, "similarity_boost": voice_style.warmth}}
            headers = {"xi-api-key": self.api_key, "accept": "audio/wav", "content-type": "application/json"}
